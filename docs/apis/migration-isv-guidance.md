...
> [!Note]
>Microsoft will start enforcing the proper usage roles in Q` 2020. Vendors who continue to run migration in user roles can expect to experience increasing throttling and poor performance.
